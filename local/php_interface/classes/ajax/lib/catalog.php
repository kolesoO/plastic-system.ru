...
class Catalog
{
     ...
     * @return array
     */
    public function getCatalogItemFromTop($arFullParams)
    {
        global $APPLICATION;

        $GLOBALS['arCatalogTopFilter'] = array_merge(
            $arFullParams['GLOBAL_FILTER'],
            [
                'ID' => $arFullParams['item_id']
            ]
        );
        $arCatalogTopParams = [
            "IMAGE_SIZE" => [
        ...
        $APPLICATION->IncludeComponent(
            ...
            "preview",
            Array(
                "OFFER_ID_SELECTED" => $arFullParams['offer_id'],
        ...
        return ["js_callback" => "getCatalogItemFromTopCallBack", "html" => $return];
    }
