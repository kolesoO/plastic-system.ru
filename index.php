...
$APPLICATION->SetPageProperty("description", "ООО &#171;Пластик Система&#187; торгово-производственная компания, представляющая широкую гамму продукции на рынке полимерных материалов уже более 11 лет. Компания специализируется на производстве и оптовой поставке листовых пластиков из сотового полипропилена (замена гофрокартона), сотового и монолитного поликарбоната, пластиковых паллет, пластиковых контейнеров, ящиков, а так же других изделий из пластика на различные предприятия России и ближнего Зарубежья.");
$APPLICATION->SetTitle("О компании - Складские лотки и пластиковая тара от компании ООО «Пластик Система»");
...
$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "OFFERS_LIMIT" => "0",
        "OFFERS_PROPERTY_CODE" => array("RAZMER", "TSVET", "CML2_ARTICLE", "STATUS", "PRICE_FROM"),
